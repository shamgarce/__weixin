...
include("../../wechat-php-sdk-master/errCode.php");


$opt = array(
//        'appsecret'=>'xxxxxxxxxxxxxxxxxxxxxxxxxx',//填写高级调用功能的密钥
//        'appid'=>'wxxxxxxxxxxxxxx'	//填写高级调用功能的appid
        'appid'=>'wx1b69d3d01a93be52', //填写高级调用功能的app id, 请在微信开发模式后台查询
        'appsecret'=>'d27a525edce19ea134652b76ef9de54e ', //填写高级调用功能的密钥
);
...
<script src="jsapi-demo-6.1.js?ts=<?php echo $js_sign['timestamp']; ?>"> </script>
</html>